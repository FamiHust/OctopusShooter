...
public class AddDeckPopup : BasePopUp
{
    ...
    public void AddBoosterReward(int amount = 1)
    {
        ...
        {
            BoosterManager.Instance.AddBooster(Const.BOOSTER_ADDSLOT, safeAmount);
        }
        else if (PlayerData.Instance != null)
        {
            PlayerData.Instance.AddBooster(Const.BOOSTER_ADDSLOT, safeAmount);
        }
    }
